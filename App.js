...
import PatientTrackRecord from "./components/TrackRecord/PatientTrackRecord";
import DoctorTrackRecord from "./components/TrackRecord/DoctorTrackRecord";
    ...
    <div className="App">
      <Router>
        ...
        <Switch>
          ...
          <Route path="/patient_records" exact component={DoctorTrackRecord} />
          <Route path="/track_records" exact component={PatientTrackRecord} />
        </Switch> 
      </Router>
    </div>
  );
